        ...
        <div>
         ...
         <div className='schedule-card'>
            <div className='schedule-section-card'>
                   <div> <span id='card-title'>Health checkup complete<span  className='schedule-emoji'> 💉 </span></span> </div>
                <div><span>11:00 AM</span></div>
            </div>
             <div className='schedule-section-card'>
                  <div> <span id='card-title'>Ophthalmologist<span  className='schedule-emoji'> 👁️ </span></span> </div>
         ...
         <div className='schedule-card'>
            <div className='schedule-section-card'>
             ...
             <div className='schedule-section-card'>
                <div> <span id='card-title'>Neurologist<span  className='schedule-emoji'> 🙎‍♂️ </span></span> </div>
